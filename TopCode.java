...
public class TopCode {
   ...
   protected static final int SECTORS = 13;
   ...
   protected static final float ARC = (2 * PI / SECTORS);
 ...
 */
   protected void printBits(int bits) {
     Logger logger = Logger.getLogger(TopCode.class.getName());
      for (int i=SECTORS-1; i>=0; i--) {
         if (((bits>>i) & 0x01) == 1) {
